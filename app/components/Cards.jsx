  ...
  return (
    <div className="bg-gray-900 py-28 sm:py-36">
      <div className="mx-auto max-w-7xl px-8 lg:px-12">
        <h2 className="text-center text-2xl font-semibold text-indigo-500">
          Elite QB Watch
        </h2>
        <p className="mx-auto mt-4 max-w-3xl text-center text-6xl font-bold tracking-tight text-white sm:text-7xl">
